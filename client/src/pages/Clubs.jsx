...
const MOCK_CLUBS = [
  ...
  { id: 'cult-2', name: 'Tourism Club', category: 'Cultural', members: 245, bio: 'Exploring hidden gems and experiencing diverse cultures. We organize heritage walks and trips.', logo: 'TC', banner: 'https://picsum.photos/seed/tourism/600/200', isJoined: false },
  { id: 'sports-2', name: 'Sports Club', category: 'Sports', members: 560, bio: 'The ultimate destination for all sports enthusiasts. From indoor games to outdoor leagues.', logo: 'SC', banner: 'https://picsum.photos/seed/fitness/600/200', isJoined: false },
  { id: 'social-2', name: 'NSS', category: 'Social', members: 1200, bio: 'National Service Scheme. Committed to social welfare, community service, and nation building.', logo: 'NS', banner: 'https://picsum.photos/seed/service/600/200', isJoined: false },
  { id: 'social-3', name: 'Green Club', category: 'Social', members: 180, bio: 'Advocating for environmental preservation and sustainability through campus-wide initiatives.', logo: 'GC', banner: 'https://picsum.photos/seed/nature/600/200', isJoined: false },
  { id: 'acad-2', name: 'Maths Club', category: 'Academic', members: 95, bio: 'Deciphering the language of the universe. Join us for math puzzles, olympiads, and logic sessions.', logo: 'MC', banner: 'https://picsum.photos/seed/math/600/200', isJoined: false },
  { id: 'acad-3', name: 'Science Club', category: 'Academic', members: 210, bio: 'Conducting experiments and exploring scientific breakthroughs across all major disciplines.', logo: 'SX', banner: 'https://picsum.photos/seed/science/600/200', isJoined: false },
  { id: 'sports-3', name: 'Yoga Club', category: 'Sports', members: 340, bio: 'Uniting mind, body, and soul. Discover inner peace and physical wellness through daily yoga.', logo: 'YC', banner: 'https://picsum.photos/seed/yoga/600/200', isJoined: false },
  { id: 'cult-3', name: 'Film Club', category: 'Cultural', members: 480, bio: 'For the love of cinema. We screen classics, host film discussions, and organize short film events.', logo: 'FC', banner: 'https://picsum.photos/seed/movie/600/200', isJoined: false },
  { id: 'cult-4', name: 'Music Club', category: 'Cultural', members: 630, bio: 'A symphony of talents. We organize jam sessions, concerts, and music production workshops.', logo: 'MS', banner: 'https://picsum.photos/seed/music/600/200', isJoined: false },
  { id: 'cult-5', name: 'Drama Club', category: 'Cultural', members: 215, bio: 'Bringing stories to life on stage. Join us for acting, directing, and stagecraft development.', logo: 'DR', banner: 'https://picsum.photos/seed/drama/600/200', isJoined: false },
  { id: 'cult-6', name: 'Art Club', category: 'Cultural', members: 390, bio: 'Where creativity meets canvas. Explore fine arts, digital illustration, and mural painting.', logo: 'AC', banner: 'https://picsum.photos/seed/art/600/200', isJoined: false },
  { id: 'tech-3', name: 'Design Club', category: 'Technical', members: 450, bio: 'Shaping user experiences and visual aesthetics. Focus on UI/UX, branding, and product design.', logo: 'DC', banner: 'https://picsum.photos/seed/design/600/200', isJoined: false },
];
